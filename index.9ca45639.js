 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(t){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];throw Nt.apply(void 0,[t].concat(e(d)(n)))}function At(t){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];return Nt.apply(void 0,[t].concat(e(d)(n)))}function Lt(t,r,n){var i=Object.assign(Object.assign({},Et()),e(oe)({},r,n));return new J("auth","Firebase",i).create(r,{appName:t.name})}function Nt(t){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];var a;if("string"!=typeof t){var o,s=n[0],u=e(d)(n.slice(1));return u[0]&&(u[0].appName=t.name),(o=t._errorFactory).create.apply(o,[s].concat(e(d)(u)))}return(a=St).create.apply(a,[t].concat(e(d)(n)))}function Pt(t,r){for(var n=arguments.length,i=new Array(n>2?n-2:0),a=2;a<n;a++)i[a-2]=arguments[a];if(!t)throw Nt.apply(void 0,[r].concat(e(d)(i)))}function Dt(e){var t="INTERNAL ASSERTION FAILED: "+e;throw Rt(t),new Error(t)}function Mt(e,t){e||Dt(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function qr(e){var t,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[];switch(e){case"Browser":t=Nr(V());break;case"Worker":t="".concat(Nr(V()),"-").concat(e);break;default:t=e}var n=r.length?r.join(","):"FirebaseCore-web";return"".concat(t,"/","JsCore","/").concat(rt,"/").concat(n)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
var Ln=function(t){"use strict";e(l)(n,t);var r=e(I)(n);function n(t,i,a,o){var c,l;return e(u)(this,n),(c=r.call(this,i.code,i.message)).operationType=a,c.user=o,Object.setPrototypeOf(e(s)(c),n.prototype),c.customData={appName:t.name,tenantId:null!==(l=t.tenantId)&&void 0!==l?l:void 0,_serverResponse:i.customData._serverResponse,operationType:a},c}return e(c)(n,null,[{key:"_fromErrorAndOperation",value:function(e,t,r,i){return new n(e,t,r,i)}}]),n}(K);function Nn(e,t,r,n){return("reauthenticate"===t?r._getReauthenticationResolver(e):r._getIdTokenResponse(e)).catch((function(r){if("auth/multi-factor-auth-required"===r.code)throw Ln._fromErrorAndOperation(e,r,t,n);throw r}))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
at("firebase","9.14.0","app");function Aa(){document.querySelector("main").insertAdjacentHTML("afterbegin",' <div class="container__spinner"><h2>Looking for the best options</h2>  <div class="wrapper"><div class="loader"><div class="spinner"></div>            </div><div class="loader"><div class="spinner"></div></div><div class="loader"> <div class="spinner"></div></div><div class="loader"><div class="spinner"></div></div><div class="loader"><div class="spinner"></div></div> <div class="loader"><div class="spinner"></div></div><div class="loader"><div class="spinner"></div></div><div class="loader"><div class="spinner"></div></div></div></div>')}function La(){document.querySelector("main").removeChild(document.querySelector(".container__spinner"))}a=i("bpxeT"),o=i("2TvXO");var Na,Pa=i("eopHt"),Da=i("dYN6e"),Ma=i("lvC14"),Ua=i("cqmI4"),ja=(Na=e(a)(e(o).mark((function t(){var r,n,i,a,s,u,c=arguments;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return c.length>0&&void 0!==c[0]&&c[0],e.prev=1,r="",r=localStorage.getItem("page")?localStorage.getItem("page"):1,e.next=6,(0,Pa.getPopular)(r);case 6:n=e.sent,i=n.data.results,s=null!==(a=(0,Ma.getGenreOptions)())&&void 0!==a?a:[],u=(0,Da.makeMovieList)(i,s),Ua.listRef.innerHTML=u,localStorage.setItem("movieList",JSON.stringify(u)),e.next=18;break;case 15:e.prev=15,e.t0=e.catch(1),console.log(e.t0);case 18:case"end":return e.stop()}}),t,null,[[1,15]])}))),function(){return Na.apply(this,arguments)}),Fa=(Ma=i("lvC14"),i("cP0sx"));i("cqmI4");a=i("bpxeT"),o=i("2TvXO");var Va,Ha=i("1VFfL"),Ba=(Ua=i("cqmI4"),Pa=i("eopHt"),Da=i("dYN6e"),Ma=i("lvC14"),i("1GZuu"));function Wa(e,t,r){var n,i,a,o,s;function u(){var c=Date.now()-o;c<t&&c>=0?n=setTimeout(u,t-c):(n=null,r||(s=e.apply(a,i),a=i=null))}null==t&&(t=100);var c=function(){a=this,i=arguments,o=Date.now();var c=r&&!n;return n||(n=setTimeout(u,t)),c&&(s=e.apply(a,i),a=i=null),s};return c.clear=function(){n&&(clearTimeout(n),n=null)},c.flush=function(){n&&(s=e.apply(a,i),a=i=null,clearTimeout(n),n=null)},c}Wa.debounce=Wa,Va=Wa;var za;Fa=i("cP0sx");function qa(){return(qa=e(a)(e(o).mark((function t(r){var n,i,a,s,u,c,l,f,d;return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(r.preventDefault(),za=r.currentTarget.searchQuery.value.trim(),Aa(),za){t.next=8;break}return Ua.errorRef.classList.add("show-error"),setTimeout((function(){Ua.errorRef.classList.remove("show-error")}),3e3),La(),t.abrupt("return");case 8:return t.next=10,(0,Pa.getBySearchName)(za);case 10:if(n=t.sent,i=n.data,a=i.results,s=i.total_results,u=(0,Ba.makePaginationOptions)(s),0!==a.length){t.next=18;break}return Ua.errorRef.classList.add("show-error"),setTimeout((function(){Ua.errorRef.classList.remove("show-error")}),3e3),La(),t.abrupt("return");case 18:La(),Ua.errorRef.classList.remove("show-error"),l=null!==(c=(0,Ma.getGenreOptions)())&&void 0!==c?c:[],f=(0,Da.makeMovieList)(a,l),Ua.listRef.innerHTML=f,Ua.searchListRef.innerHTML="";try{Ba.pagination.reset(),Ba.pagination.off("afterMove",Ba.updateMoviesList),(d=new(e(Ha))(Ua.paginationContainer,u)).off("afterMove",Ga),d.on("afterMove",Ga)}catch(e){console.log(e)}case 26:case"end":return t.stop()}}),t)})))).apply(this,arguments)}function Ga(e){return Ka.apply(this,arguments)}function Ka(){return(Ka=e(a)(e(o).mark((function t(r){var n,i,a,s,u,c;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.page,localStorage.setItem("page",n),e.next=4,(0,Pa.getBySearchName)(za,n);case 4:i=e.sent,a=i.data.results,console.log(i.data),u=null!==(s=(0,Ma.getGenreOptions)())&&void 0!==s?s:[],c=(0,Da.makeMovieList)(a,u),Ua.listRef.innerHTML=c,document.documentElement.scrollTo({top:0,behavior:"smooth"});case 12:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Ja(){return(Ja=e(a)(e(o).mark((function t(r){var n,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(Ua.searchListRef.classList.remove("visually-hidden"),Ua.searchListRef.innerHTML="",za=r.target.value.trim()){e.next=6;break}return Ua.searchListRef.classList.add("visually-hidden"),e.abrupt("return");case 6:return e.next=8,(0,Pa.getBySearchName)(za);case 8:if(n=e.sent,0!==(i=n.data.results).length){e.next=14;break}return Ua.errorRef.classList.add("show-error"),setTimeout((function(){Ua.errorRef.classList.remove("show-error")}),3e3),e.abrupt("return");case 14:Ua.searchListRef.insertAdjacentHTML("beforeend",Xa(i.slice(0,5)));case 15:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Xa(e){var t="";return e.forEach((function(e){var r=e.title,n=e.id,i=e.release_date;return t+='<li class="search-list-item" data-id='.concat(n,">").concat(r,' <span class="release-date">(').concat(i?i.slice(0,4):"no info",")</span></li>")})),t}Ua.searchFormRef.addEventListener("submit",(function(e){return qa.apply(this,arguments)})),Ua.searchInputRef.addEventListener("input",(0,Va.debounce)((function(e){return Ja.apply(this,arguments)}),700)),Ua.searchListRef.addEventListener("click",Fa.openMovieInfo),i("1GZuu"),i("a4V2g");var Ya=i("9iAID"),$a=i("5p8r0"),Qa=(Ua=i("cqmI4"),function(){(0,Ma.setGenreOptions)(),ja(),Ua.listRef.addEventListener("click",Fa.openMovieInfo),Ya.btnUp.addEventListener(),(0,$a.darkmode)()}),Za={apiKey:"AIzaSyCGogj3fGE6tA7X8GsT_L5_K13QQ4ppLp4",authDomain:"team-project-filmoteka-fd028.firebaseapp.com",projectId:"team-project-filmoteka-fd028",storageBucket:"team-project-filmoteka-fd028.appspot.com",messagingSenderId:"647650787195",appId:"1:647650787195:web:c479a609e1b68f161ec7de",measurementId:"G-0KS32BVV0R"};Object.freeze(Za);var eo=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:it(),t=Qe(e,"auth");if(t.isInitialized())return t.getImmediate();var r=Ft(e,{popupRedirectResolver:_a,persistence:[bi,Yn,Qn]}),n=q("authTokenSyncURL");if(n){var i=Ca(n);qn(r,i,(function(){return i(r.currentUser)})),zn(r,(function(e){return i(e)}))}var a=W("auth");return a&&Yr(r,"http://".concat(a)),r}(nt(Za)),to=document.querySelector(".form-signin"),ro=document.querySelector(".sign"),no=document.querySelector(".login"),io=document.querySelector(".out"),ao=document.querySelector(".autorization"),oo=document.querySelector(".errorMessage"),so=document.querySelector(".backdropForm"),uo=document.querySelector("body"),co=document.querySelector(".form-signin"),lo=document.querySelector(".form__close-icone"),fo=0,ho=function(e){e.preventDefault(),"Escape"===e.key&&go()},po=function(){co.classList.add("active"),io.classList.remove("active"),ao.classList.remove("active"),so.classList.add("active"),document.addEventListener("keydown",ho),fo+=1},vo=function(){co.classList.remove("active"),"anonym"===localStorage.getItem("statusUser")?(ao.classList.add("active"),io.classList.remove("active")):(io.classList.add("active"),ao.classList.remove("active")),so.classList.remove("active"),uo.classList.remove("scroll-hidden"),lo.removeEventListener("click",yo),no.removeEventListener("click",bo),ro.removeEventListener("click",_o),document.removeEventListener("keydown",ho)},mo=function(e){"auth/wrong-password"==e.code?oo.innerHTML="Wrong password. Try again.":"auth/invalid-email"==e.code?oo.innerHTML="Wrong email. Try again.":oo.innerHTML="Error: ".concat(e.message)},go=function(){localStorage.setItem("statusUser","anonym"),fo<1&&Qa(),vo()},yo=lo.addEventListener("click",(function(e){e.preventDefault(),go()})),ko=function(){var t=e(a)(e(o).mark((function t(){var r,n;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=document.querySelector(".form-control-mail").value,n=document.querySelector(".form-control-password").value,e.prev=2,Aa(),e.next=6,t=r,i=n,Vn(ae(eo),wn.credential(t,i));case 6:e.sent,localStorage.setItem("statusUser","identificationUser"),fo<1&&Qa(),vo(),e.next=15;break;case 12:e.prev=12,e.t0=e.catch(2),mo(e.t0);case 15:return e.prev=15,to.reset(),La(),e.finish(15);case 19:case"end":return e.stop()}var t,i}),t,null,[[2,12,15,19]])})));return function(){return t.apply(this,arguments)}}(),bo=no.addEventListener("click",(function(e){e.preventDefault(),ko()})),wo=function(){var t=e(a)(e(o).mark((function t(){var r,n,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=document.querySelector(".form-control-mail").value,n=document.querySelector(".form-control-password").value,e.prev=2,Aa(),e.next=6,Bn(eo,r,n);case 6:i=e.sent,localStorage.setItem("statusUser","identificationUser"),console.log(i.user),fo<1&&Qa(),vo(),e.next=16;break;case 13:e.prev=13,e.t0=e.catch(2),mo(e.t0);case 16:return e.prev=16,to.reset(),La(),e.finish(16);case 20:case"end":return e.stop()}}),t,null,[[2,13,16,20]])})));return function(){return t.apply(this,arguments)}}(),_o=ro.addEventListener("click",(function(e){e.preventDefault(),wo()})),Io=function(){var t=e(a)(e(o).mark((function t(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:t=function(e){e?(uo.classList.remove("scroll-hidden"),vo(),oo.innerHTML=""):(po(),uo.classList.add("scroll-hidden"),oo.innerHTML="You are not logged in")},r=void 0,n=void 0,ae(eo).onAuthStateChanged(t,r,n);case 1:case"end":return e.stop()}var t,r,n}),t)})));return function(){return t.apply(this,arguments)}}();"anonym"!==localStorage.getItem("statusUser")?Io():vo();var xo=function(){var t=e(a)(e(o).mark((function t(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,ae(eo).signOut();case 2:localStorage.setItem("statusUser","anonym"),"anonym"===localStorage.getItem("statusUser")?(ao.classList.add("active"),io.classList.remove("active")):(io.classList.add("active"),ao.classList.remove("active"));case 4:case"end":return e.stop()}}),t)})));return function(){return t.apply(this,arguments)}}();io.addEventListener("click",(function(e){e.preventDefault(),xo()})),ao.addEventListener("click",(function(e){e.preventDefault(),xo(),po()})),localStorage.getItem("movieList")&&(Qa(),Ua.listRef.innerHTML=JSON.parse(localStorage.getItem("movieList")));$a=i("5p8r0");document.addEventListener("DOMContentLoaded",(function(){Qa(),(0,$a.darkmode)()}))}();
//# sourceMappingURL=index.9ca45639.js.map

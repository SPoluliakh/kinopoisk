 ...
 * limitations under the License.
 */
at("firebase","9.14.0","app");function Aa(){document.querySelector("main").insertAdjacentHTML("afterbegin",' <div class="container__spinner"><h2>Looking for the best options</h2>  <div class="wrapper"><div class="loader"><div class="spinner"></div>            </div><div class="loader"><div class="spinner"></div></div><div class="loader"> <div class="spinner"></div></div><div class="loader"><div class="spinner"></div></div><div class="loader"><div class="spinner"></div></div> <div class="loader"><div class="spinner"></div></div><div class="loader"><div class="spinner"></div></div><div class="loader"><div class="spinner"></div></div></div></div>')}function La(){document.querySelector("main").removeChild(document.querySelector(".container__spinner"))}var Na=i("jgLRi"),Pa=i("lvC14"),Da=i("cP0sx");i("cqmI4");a=i("bpxeT"),o=i("2TvXO");var Ma,Ua=i("1VFfL"),ja=i("cqmI4"),Fa=i("eopHt"),Va=i("dYN6e"),Ha=(Pa=i("lvC14"),i("1GZuu"));function Ba(e,t,r){var n,i,a,o,s;function u(){var c=Date.now()-o;c<t&&c>=0?n=setTimeout(u,t-c):(n=null,r||(s=e.apply(a,i),a=i=null))}null==t&&(t=100);var c=function(){a=this,i=arguments,o=Date.now();var c=r&&!n;return n||(n=setTimeout(u,t)),c&&(s=e.apply(a,i),a=i=null),s};return c.clear=function(){n&&(clearTimeout(n),n=null)},c.flush=function(){n&&(s=e.apply(a,i),a=i=null,clearTimeout(n),n=null)},c}Ba.debounce=Ba,Ma=Ba;var Wa;Da=i("cP0sx");function za(){return(za=e(a)(e(o).mark((function t(r){var n,i,a,s,u,c,l,f,d;return e(o).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(r.preventDefault(),Wa=r.currentTarget.searchQuery.value.trim(),Aa(),Wa){t.next=8;break}return ja.errorRef.classList.add("show-error"),setTimeout((function(){ja.errorRef.classList.remove("show-error")}),3e3),La(),t.abrupt("return");case 8:return t.next=10,(0,Fa.getBySearchName)(Wa);case 10:if(n=t.sent,i=n.data,a=i.results,s=i.total_results,u=(0,Ha.makePaginationOptions)(s),0!==a.length){t.next=18;break}return ja.errorRef.classList.add("show-error"),setTimeout((function(){ja.errorRef.classList.remove("show-error")}),3e3),La(),t.abrupt("return");case 18:La(),ja.errorRef.classList.remove("show-error"),l=null!==(c=(0,Pa.getGenreOptions)())&&void 0!==c?c:[],f=(0,Va.makeMovieList)(a,l),ja.listRef.innerHTML=f,ja.searchListRef.innerHTML="";try{Ha.pagination.reset(),Ha.pagination.off("afterMove",Ha.updateMoviesList),(d=new(e(Ua))(ja.paginationContainer,u)).off("afterMove",qa),d.on("afterMove",qa)}catch(e){console.log(e)}case 26:case"end":return t.stop()}}),t)})))).apply(this,arguments)}function qa(e){return Ga.apply(this,arguments)}function Ga(){return(Ga=e(a)(e(o).mark((function t(r){var n,i,a,s,u,c;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.page,localStorage.setItem("page",n),e.next=4,(0,Fa.getBySearchName)(Wa,n);case 4:i=e.sent,a=i.data.results,console.log(i.data),u=null!==(s=(0,Pa.getGenreOptions)())&&void 0!==s?s:[],c=(0,Va.makeMovieList)(a,u),ja.listRef.innerHTML=c,document.documentElement.scrollTo({top:0,behavior:"smooth"});case 12:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Ka(){return(Ka=e(a)(e(o).mark((function t(r){var n,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(ja.searchListRef.classList.remove("visually-hidden"),ja.searchListRef.innerHTML="",Wa=r.target.value.trim()){e.next=6;break}return ja.searchListRef.classList.add("visually-hidden"),e.abrupt("return");case 6:return e.next=8,(0,Fa.getBySearchName)(Wa);case 8:if(n=e.sent,0!==(i=n.data.results).length){e.next=14;break}return ja.errorRef.classList.add("show-error"),setTimeout((function(){ja.errorRef.classList.remove("show-error")}),3e3),e.abrupt("return");case 14:ja.searchListRef.insertAdjacentHTML("beforeend",Ja(i.slice(0,5)));case 15:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Ja(e){var t="";return e.forEach((function(e){var r=e.title,n=e.id,i=e.release_date;return t+='<li class="search-list-item" data-id='.concat(n,">").concat(r,' <span class="release-date">(').concat(i?i.slice(0,4):"no info",")</span></li>")})),t}ja.searchFormRef.addEventListener("submit",(function(e){return za.apply(this,arguments)})),ja.searchInputRef.addEventListener("input",(0,Ma.debounce)((function(e){return Ka.apply(this,arguments)}),700)),ja.searchListRef.addEventListener("click",Da.openMovieInfo),i("1GZuu"),i("a4V2g");var Xa=i("9iAID"),Ya=i("5p8r0"),$a=(ja=i("cqmI4"),function(){(0,Pa.setGenreOptions)(),(0,Na.moviesListMarkupFirstRender)(),ja.listRef.addEventListener("click",Da.openMovieInfo),Xa.btnUp.addEventListener(),(0,Ya.darkmode)()}),Qa={apiKey:"AIzaSyCGogj3fGE6tA7X8GsT_L5_K13QQ4ppLp4",authDomain:"team-project-filmoteka-fd028.firebaseapp.com",projectId:"team-project-filmoteka-fd028",storageBucket:"team-project-filmoteka-fd028.appspot.com",messagingSenderId:"647650787195",appId:"1:647650787195:web:c479a609e1b68f161ec7de",measurementId:"G-0KS32BVV0R"};Object.freeze(Qa);var Za,eo=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:it(),t=Qe(e,"auth");if(t.isInitialized())return t.getImmediate();var r=Ft(e,{popupRedirectResolver:_a,persistence:[bi,Yn,Qn]}),n=q("authTokenSyncURL");if(n){var i=Ca(n);qn(r,i,(function(){return i(r.currentUser)})),zn(r,(function(e){return i(e)}))}var a=W("auth");return a&&Yr(r,"http://".concat(a)),r}(nt(Qa)),to=document.querySelector(".form-signin"),ro=document.querySelector(".sign"),no=document.querySelector(".login"),io=document.querySelector(".out"),ao=document.querySelector(".autorization"),oo=document.querySelector(".errorMessage"),so=document.querySelector(".backdropForm"),uo=document.querySelector("body"),co=document.querySelector(".form-signin"),lo=document.querySelector(".form__close-icone"),fo=0,ho=function(e){e.preventDefault(),"Escape"===e.key&&go()},po=function(){co.classList.add("active"),io.classList.remove("active"),ao.classList.remove("active"),so.classList.add("active"),document.addEventListener("keydown",ho),fo+=1},vo=function(){co.classList.remove("active"),"anonym"===localStorage.getItem("statusUser")?(ao.classList.add("active"),io.classList.remove("active")):(io.classList.add("active"),ao.classList.remove("active")),so.classList.remove("active"),uo.classList.remove("scroll-hidden"),lo.removeEventListener("click",yo),no.removeEventListener("click",bo),ro.removeEventListener("click",_o),document.removeEventListener("keydown",ho)},mo=function(e){"auth/wrong-password"==e.code?oo.innerHTML="Wrong password. Try again.":"auth/invalid-email"==e.code?oo.innerHTML="Wrong email. Try again.":oo.innerHTML="Error: ".concat(e.message)},go=function(){localStorage.setItem("statusUser","anonym"),fo<1&&$a(),vo()},yo=lo.addEventListener("click",(function(e){e.preventDefault(),go()})),ko=(Za=e(a)(e(o).mark((function t(){var r,n;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=document.querySelector(".form-control-mail").value,n=document.querySelector(".form-control-password").value,e.prev=2,Aa(),e.next=6,t=r,i=n,Vn(ae(eo),wn.credential(t,i));case 6:e.sent,localStorage.setItem("statusUser","identificationUser"),fo<1&&$a(),vo(),e.next=15;break;case 12:e.prev=12,e.t0=e.catch(2),mo(e.t0);case 15:return e.prev=15,to.reset(),La(),e.finish(15);case 19:case"end":return e.stop()}var t,i}),t,null,[[2,12,15,19]])}))),function(){return Za.apply(this,arguments)}),bo=no.addEventListener("click",(function(e){e.preventDefault(),ko()})),wo=function(){var t=e(a)(e(o).mark((function t(){var r,n,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=document.querySelector(".form-control-mail").value,n=document.querySelector(".form-control-password").value,e.prev=2,Aa(),e.next=6,Bn(eo,r,n);case 6:i=e.sent,localStorage.setItem("statusUser","identificationUser"),console.log(i.user),fo<1&&$a(),vo(),e.next=16;break;case 13:e.prev=13,e.t0=e.catch(2),mo(e.t0);case 16:return e.prev=16,to.reset(),La(),e.finish(16);case 20:case"end":return e.stop()}}),t,null,[[2,13,16,20]])})));return function(){return t.apply(this,arguments)}}(),_o=ro.addEventListener("click",(function(e){e.preventDefault(),wo()})),Io=function(){var t=e(a)(e(o).mark((function t(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:t=function(e){e?(uo.classList.remove("scroll-hidden"),vo(),oo.innerHTML=""):(po(),uo.classList.add("scroll-hidden"),oo.innerHTML="You are not logged in")},r=void 0,n=void 0,ae(eo).onAuthStateChanged(t,r,n);case 1:case"end":return e.stop()}var t,r,n}),t)})));return function(){return t.apply(this,arguments)}}();"anonym"!==localStorage.getItem("statusUser")?Io():vo();var xo=function(){var t=e(a)(e(o).mark((function t(){return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,ae(eo).signOut();case 2:localStorage.setItem("statusUser","anonym"),"anonym"===localStorage.getItem("statusUser")?(ao.classList.add("active"),io.classList.remove("active")):(io.classList.add("active"),ao.classList.remove("active"));case 4:case"end":return e.stop()}}),t)})));return function(){return t.apply(this,arguments)}}();io.addEventListener("click",(function(e){e.preventDefault(),xo()})),ao.addEventListener("click",(function(e){e.preventDefault(),xo(),po()})),localStorage.getItem("movieList")&&($a(),ja.listRef.innerHTML=JSON.parse(localStorage.getItem("movieList")));Ya=i("5p8r0");document.addEventListener("DOMContentLoaded",(function(){$a(),(0,Ya.darkmode)()}))}();
//# sourceMappingURL=index.2a187773.js.map
